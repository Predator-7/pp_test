...
bot.command('start', ctx => {
    ...
    bot.telegram.sendMessage(ctx.chat.id, 'Hello there! Welcome to competitive programming practice bot. \n \n Type practice to start practicing. This will give 10 random questions on a selected topic. \n \n  Type quiz to start quiz. This will give a random question on a selected topic / difficulty. \n \n Type "/help" to get information about bot and instructions are also there in description.')
